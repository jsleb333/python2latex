...
from python2latex import Plot, PREDEFINED_CMAPS, PREDEFINED_PALETTES
import numpy as np
...
if __name__ == "__main__":
    ...
    sec += """
    The ``holi'' color map was designed to provide a set of easily distinguishable hues for any needed number of colors. It is optimized for palettes of any number of colors. It is colorblind friendly for all types of colorblindness for up to 5 colors, but it is still fairly good for more colors. The name ``holi'' comes from the Hindu festival of colors. This is the default color map of python2latex.

    Below is a graph of the color map in the J-h axes of the CIECAM02 color model, followed by the colors generated by the associated dynamic palette according to the number of colors desired.
    """
